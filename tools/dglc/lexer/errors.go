...
var (
	...
	ErrEof              = errors.New("github.com/dywoq/dywoqgame/tools/dglc/lexer: end of file")
	ErrNegativeAdvance  = errors.New("github.com/dywoq/dywoqgame/tools/dglc/lexer: negative advance")
)
